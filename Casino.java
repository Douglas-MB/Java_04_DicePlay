...
public class Casino {
    ...
    public void auxPlayer(Player player){
        setAuxRollPlayer(player.getRollPlayer());
    ...
    public void showResult(){
        ...
        if(result){
            ...
            win++;
            setAuxMoney(getAuxMoney()+ 2*(getCasinoDie().getRollCnt()));
            System.out.println("Yur current money is "+getAuxMoney());
        }
        System.out.println("-------------------------------------------");
    }
    ...
    public void casinoToRoll(){
        setCasinoRoll(casinoDie.rollDie(MyTools.rng(7)));
